...
export function initRenderer(containerEl: HTMLElement | null, emptyStateEl: HTMLElement | null) {
  container = containerEl;
  emptyState = emptyStateEl;
}

export function addTranscriptItem(text: string, isFinal: boolean, isAgent = false) {
