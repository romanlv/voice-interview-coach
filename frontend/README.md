...
This repository contains the shared frontend for Deepgram live transcription starter applications. It is designed to be used as a git submodule within backend starter projects.
